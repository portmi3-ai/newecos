...
import { FileText, FileEdit, FileCheck, Download, Share2, PlusCircle, Folder } from 'lucide-react';
import { FundingDocument, DocumentType, DataRoom } from '../../types/advisorAgent';
