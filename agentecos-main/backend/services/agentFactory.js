...
Please provide comprehensive financial advice addressing the client's needs.`
  ...
  'meta-devops': {
    'autonomous-devops-agent': {
      name: 'Meta DevOps Agent',
      description: 'Conversational AI agent for digital task automation, leveraging NLP/NLU, Hugging Face, and Gemini APIs.',
      capabilities: [
        'nlp', 'nlu', 'task-execution', 'script-running', 'cloud-management',
        'conversational-interface', 'autonomous-reasoning', 'secure-actioning'
      ],
      agentType: 'meta',
      modelConfig: {
        model: 'gpt-4',
      ...
      promptTemplate: `You are a Meta DevOps Agent. You understand natural language instructions, can execute digital tasks (run scripts, deploy, monitor, etc.), and interact with users and other agents. 
You leverage Hugging Face and Gemini APIs for intent parsing and reasoning. You always clarify ambiguous requests, confirm before executing sensitive actions, and provide clear feedback and logs.`
    }
  }
...
class AgentFactory {
  ...
  async createAgentsFromBlueprint(blueprintId, selectedRoles, userId) {
    try {
      ...
      let blueprint;
      if (blueprintId === 'advisor-agent-team') {
        blueprint = {
          id: blueprintId,
          name: 'Advisor Agent Team',
          industryId: 'funding-advisory',
          description: 'AI-powered team for funding, investment, and go-to-market strategy',
          roles: [
            {
              ...
              level: 'specialized',
              responsibilities: [
                'Guide users through funding series, revenue range, valuation, and sales motion',
                'Analyze company profile and metrics',
                'Recommend optimal funding strategy and timing',
                'Suggest key metrics to focus on before fundraising'
              ]
            },
            {
              ...
              level: 'specialized',
              reportsTo: 'funding-strategy-advisor',
              responsibilities: [
                'Identify ideal investors based on company profile, sector, and funding stage',
                'Rank investors by fit score',
                'Present detailed investor profiles and portfolio analysis',
                'Identify common connections and warm intros'
              ]
            },
            {
              ...
              level: 'specialized',
              reportsTo: 'investor-matchmaker',
              responsibilities: [
                'Draft personalized outreach emails and LinkedIn messages',
                'Track responses and engagement metrics',
                'Schedule follow-ups and meetings',
                'Analyze response patterns to improve outreach'
              ]
            },
            {
              id: 'documentation-data-room',
              name: 'Documentation & Data Room',
              level: 'specialized',
              reportsTo: 'outreach-engagement',
              responsibilities: [
                'Generate funding documents based on company profile',
                'Create and manage secure investor data rooms',
                'Track document engagement and viewership',
                'Update materials with latest metrics and data'
              ]
            },
            {
              ...
              reportsTo: 'funding-strategy-advisor',
              responsibilities: [
                'Track competitor funding rounds and announcements',
                'Analyze competitor product updates and pricing',
